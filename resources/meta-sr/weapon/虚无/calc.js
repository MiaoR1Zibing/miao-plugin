export default function(staticIdx, keyIdx) {
  return {
    以世界之名: [ keyIdx("对陷入负面效果的敌人伤害提高[dmg]%，释放战技的功力提高[atkPct]%", { dmg: 1, atkPct: 3 }) ],
    决心如汗珠般闪耀: [ keyIdx("攻陷状态敌方防御力降低[enemyDef]%", "enemyDef", 2) ],
    匿影: [],
    后会有期: [],
    幽邃: [ keyIdx("使装备者的效果命中提高[effPct]%", "effPct", 1) ],
    延长记号: [
      staticIdx(1, "stance"),
    ...
    渊环: [ keyIdx("对减速状态的目标伤害提高[dmg]%", "dmg", 1) ],
    猎物的视线: [ staticIdx(1, "effPct") ],
    新手任务开始前: [ staticIdx(1, "effPct") ],
    雨一直下: [
      staticIdx(1, "effPct"),
    ...
    海洋为何而歌: [
      ...
      (tables) => {
        return {
          title: "【魂迷】状态下，6个装备者施加的负面状态，受到的持续伤害提高[dotEnemydmg]%，受到我方目标攻击时，使攻击者速度提高[speedPct]%",
          data: {

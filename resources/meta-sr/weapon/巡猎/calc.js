export default function(staticIdx, keyIdx) {
  return {
    ...
    "春水初生": [ keyIdx("进入战斗提高速度[speedPct]%，伤害[dmg]%", { speedPct: 1, dmg: 2 }) ],
    "点个关注吧！": [
      (tables) => {
        return {
    ...
    "相抗": [ keyIdx("消灭敌方目标后，速度提高[speedPct]%", "speedPct", 1) ],
    "离弦": [ keyIdx("消灭敌方目标后，攻击力[atkPct]%", "atkPct", 1) ],
    "论剑": [
      (tables) => {
        return {
    ...
    "锋镝": [ keyIdx("战斗开始时暴击率提高[cpct]%", "cpct", 1) ],
    "烦恼着，幸福着": [
      staticIdx(1, "cpct"),
